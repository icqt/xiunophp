...
2022年9月19日	解决xiuno4.0.4在php7.4+环境异常的问题

把xiunophp. php和xiunophp.min.php文件中

$get_magic_quotes_gpc = get_magic_quotes_gpc()
改成

$get_magic_quotes_gpc = 0
然后把xn_html_safe.func.php文件中

785行，938行，951行，这三行的rawtext{}的括号改为[]，因为高版本的数组不支持用{}括号了。

最后发现7.4+版本的PHP可以正常使用xiuno系统了。